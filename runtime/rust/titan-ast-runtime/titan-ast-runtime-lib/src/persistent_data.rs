...
use crate::{
    ast::{Grammar, GrammarType, NonterminalGrammar, TerminalGrammar, TokenData},
...
impl PersistentData {
    ...
    pub(crate) fn get_key_word_automata_by_input_stream(&mut self) -> KeyWordAutomata {
        ...
        let mut text_terminal_map: HashMap<TokenData, Grammar> =
    ...
    fn read_i32(&mut self) -> i32 {
        ...
        self.i32_byte_buffer.set_limit(end);
