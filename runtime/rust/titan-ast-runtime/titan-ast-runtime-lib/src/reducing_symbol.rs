...
impl ReducingSymbol {
    pub(crate) fn equals(&self, other: &Self) -> bool {
        self.end_index_of_token == other.end_index_of_token
            ...
            && self.ast_of_current_dfa_state.grammar == other.ast_of_current_dfa_state.grammar
    }
    ...
    pub(crate) fn compare(&self, other: &Self) -> Ordering {
        ...
        if self.ast_of_current_dfa_state.grammar < other.ast_of_current_dfa_state.grammar {
            return Ordering::Less;
        }
        if self.ast_of_current_dfa_state.grammar > other.ast_of_current_dfa_state.grammar {
            return Ordering::Greater;
