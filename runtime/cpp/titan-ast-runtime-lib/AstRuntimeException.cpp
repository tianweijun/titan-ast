...
AstRuntimeException::AstRuntimeException(AstRuntimeExceptionCode code,
...
const char *AstRuntimeException::what() const noexcept { return msg.c_str(); }

AstRuntimeExceptionResolver::AstRuntimeExceptionResolver() = default;

AstRuntimeExceptionResolver::~AstRuntimeExceptionResolver() = default;

void AstRuntimeExceptionResolver::throwException(
    const AstRuntimeException &ex) {
...
const std::list<AstRuntimeException> *
AstRuntimeExceptionResolver::getExceptions() {
