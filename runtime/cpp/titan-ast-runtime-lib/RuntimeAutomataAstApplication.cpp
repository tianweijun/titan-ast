...
RuntimeAutomataAstApplication *RuntimeAutomataAstApplication::clone() {
  ...
  app->persistentAutomataAstApplication = persistentAutomataAstApplication->clone();
  return app;
}
const std::list<Ast *> *RuntimeAutomataAstApplication::buildAsts(const std::string *sourceCodeFilePath) {
