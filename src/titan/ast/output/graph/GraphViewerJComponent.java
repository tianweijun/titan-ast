...
public class GraphViewerJComponent extends JComponent {
  ...
  private StringGraph strGraph;
  private int width = 800;
  private int height = 700;
  private int gapOfBox = 150;
  private FontMetrics fontMetrics;
  private double scale = 1d;

  private LinkedList<Box> boxs = new LinkedList<>();
  private LinkedList<BoxLine> boxLines = new LinkedList<>();
  private LinkedList<BoxLine> boxLineTips = new LinkedList<>();
  ...
  public static class Box2Box {
    ...
    public boolean equals(Object o) {
      ...
      if (from != null ? !from.equals(box2Box.from) : box2Box.from != null) {
        return false;
      }
      return to != null ? to.equals(box2Box.to) : box2Box.to == null;
    }
