...
public class ClangShowGraphicalViewOfAstByAutomataFileTest {
  ...
  public static void main(String[] args) throws AutomataDataIoException {
    String automataFilePath = "D://github-pro/titan/titan-ast/test/ast/titanAstGrammar.automata";
    String sourceCodeFilePath =  "D://github-pro/titan/titan-ast/test/c/C.grammar";
