...
public abstract class Grammar implements Comparable<Grammar> {
  ...
  public boolean isNormalRegexpContent() {
    return GrammarAttribute.isNormalRegexpContent(attributes);
  }

  public boolean isNfaRegexpContent() {
    return GrammarAttribute.isNfaRegexpContent(attributes);
  }

  public GrammarToken getNfaRegexpContent() {
    return GrammarAttribute.getNfaRegexpContent(attributes);
  }
