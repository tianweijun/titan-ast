...
public class TokenDfaOptimizer {
  ...
  private int[] chars;
  private LinkedList<DfaStatesGroup> willBeFinshedGroups = new LinkedList<>();
  private LinkedList<DfaStatesGroup> beFinshedGroups = new LinkedList<>();

  public TokenDfaOptimizer() {
    chars = AstContext.get().grammarCharset.getTokenDfaChars();
  }
